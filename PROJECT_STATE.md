...
| Full-scope completion | The 31 canonical rows sum to 2,388: simple unweighted average **77.0%**, recalculated median **88%**. This is distinct from the green source-validation gate and is not a 100% AiSensy parity claim. |
...
| OpenAPI | `3.1.0` · **`235` paths**. PAR-VIEW-05 adds list/create/delete Reports saved-view contracts; canonical export and generated TypeScript are synchronized. |
