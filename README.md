...
dependency/image/SBOM/runtime gates. The current source tree passes **1,683 backend tests with zero
skips** — VAL-01 stood up a real MySQL 8 and cleared the six live-migration tests that every prior
run reported as skipped — plus 946 frontend tests across 56 files, the synchronized 244-path
...
31-module table currently averages **80.7%** unweighted (recalculated median **88%**), with exact remaining work
