...
dependency/image/SBOM/runtime gates. The current source tree passes **1,652 backend tests with zero
skips** — VAL-01 stood up a real MySQL 8 and cleared the six live-migration tests that every prior
run reported as skipped — plus 918 frontend tests across 53 files, the synchronized 241-path
...
31-module table currently averages **77.3%** unweighted (recalculated median **88%**), with exact remaining work
