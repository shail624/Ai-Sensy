...
run reported as skipped — plus 977 frontend tests across 58 files, the synchronized 247-path
...
31-module table currently averages **82.5%** unweighted (recalculated median **88%**), with exact remaining work
