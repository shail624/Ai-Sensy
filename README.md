...
run reported as skipped — plus 993 frontend tests across 60 files, the synchronized 247-path
...
31-module table currently averages **85.4%** unweighted (recalculated median **88%**), with exact remaining work
