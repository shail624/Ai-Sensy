...
dependency/image/SBOM/runtime gates. The current source tree passes **1,675 backend tests with zero
skips** — VAL-01 stood up a real MySQL 8 and cleared the six live-migration tests that every prior
run reported as skipped — plus 943 frontend tests across 55 files, the synchronized 243-path
...
31-module table currently averages **80.5%** unweighted (recalculated median **88%**), with exact remaining work
