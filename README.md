...
dependency/image/SBOM/runtime gates. The current source tree passes **1,726 backend tests with zero
skips** — VAL-01 stood up a real MySQL 8 and cleared the six live-migration tests that every prior
run reported as skipped — plus 964 frontend tests across 57 files, the synchronized 247-path
...
31-module table currently averages **81.1%** unweighted (recalculated median **88%**), with exact remaining work
