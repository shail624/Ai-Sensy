"""Extend governed workspace views to Campaigns.

Revision ID: 0059_campaign_workspace_views
Revises: 0058_contacts_workspace_views
"""
...
revision = "0059_campaign_workspace_views"
down_revision = "0058_contacts_workspace_views"
branch_labels = None
depends_on = None

_PERMISSION = {
    "code": "campaigns:views_manage",
    "resource": "campaigns",
    "action": "views_manage",
    "description": "Manage organization-shared Campaign views",
}
...
def downgrade() -> None:
    _replace_workspace_constraint("'reactivation', 'contacts'")
