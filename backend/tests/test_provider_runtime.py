...
async def test_pairing_lifecycle_is_runtime_owned_persisted_and_no_store(
    ...
    # indicator (248 -> 249); UI-AIS-05 QR new chats and customer photos (249 -> 251); UI-AIS-06 sale details (251 -> 252); UI-AIS-08 message media (252 -> 253); UI-AIS-10 chat activity (253 -> 254); UI-AIS-16 CSV audience (254 -> 255); UI-AIS-17 messaging quota (255 -> 256).
    assert len(create_app().openapi()["paths"]) == 256
