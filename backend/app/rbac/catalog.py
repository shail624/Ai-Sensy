...
PERMISSION_CATALOG: tuple[tuple[str, str], ...] = (
    ...
    ("contacts:views_manage", "Manage organization-shared Contacts views"),
    ...
    ("campaigns:export", "Export governed campaign recipient results"),
    ("campaigns:views_manage", "Manage organization-shared Campaign views"),
    ("inbox:read", "View the shared inbox"),
    ("inbox:write", "Reply and act in the inbox"),
    ("inbox:assign", "Assign conversations to agents"),
    ("inbox:export", "Export governed conversation transcripts"),
    ("inbox:views_manage", "Manage organization-shared Chat History views"),
    ...
    ("analytics:views_manage", "Manage organization-shared Report views"),
    ...
    ("reactivation:views_manage", "Manage organization-shared Reactivation views"),
    ...
    ("kyc:views_manage", "Manage organization-shared KYC views"),
...
SYSTEM_ROLES: tuple[SystemRoleSpec, ...] = (
    ...
    },
    {
        ...
        "permissions": (
            ...
            "analytics:read",
            "analytics:export",
            "analytics:views_manage",
            "reactivation:read",
            "reactivation:write",
            "reactivation:transition",
            "reactivation:views_manage",
            "kyc:read",
            "kyc:write",
            "kyc:decide",
            "kyc:approve",
