...
export const REACTIVATION_SECTIONS: ReactivationSection[] = [
  ...
  { key: "documents", label: "Document Center", shortLabel: "Documents", path: "/reactivation/documents", description: "Manage governed customer files through the existing secured media library.", icon: FolderLock, phase: "Connected" },
