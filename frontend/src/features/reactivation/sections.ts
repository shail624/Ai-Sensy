...
export const REACTIVATION_SECTIONS: ReactivationSection[] = [
  ...
  },
  {
    ...
    description: "Every SIM order across all cases — serial, address, area and where it has got to.",
    icon: PackageCheck,
    permission: "sim:read",
    phase: "Connected",
  },
  {
    ...
    description: "Every activation record waiting on verification, approval or completion.",
    icon: BadgeCheck,
