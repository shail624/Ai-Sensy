...
export const REACTIVATION_SECTIONS: ReactivationSection[] = [
  ...
  { key: "kyc", label: "KYC Operations", shortLabel: "KYC", path: "/reactivation/kyc", description: "Review tenant-scoped verification cases, protected document references, appointments and separated approvals.", icon: FileCheck2, phase: "Connected" },
