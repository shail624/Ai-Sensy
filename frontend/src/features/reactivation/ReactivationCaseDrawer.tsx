...
function CaseActivity({ card }: { card: ReactivationCard }): JSX.Element {
  ...
  return (
    <div role="tabpanel" className="space-y-4">
      <section className="rounded-xl border border-border p-4">
        <div className="flex items-center gap-2"><History aria-hidden className="h-4 w-4 text-accent" /><h3 className="text-sm font-semibold text-text-primary">Stage history</h3></div>
